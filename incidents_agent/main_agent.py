...
from incidents_agent.subagents.dispatcher import dispatcher_agent
from incidents_agent.subagents.synthesizer import synthesizer_agent
...
incident_response_team = SequentialAgent(
    ...
    sub_agents=[dispatcher_agent, synthesizer_agent],
)
